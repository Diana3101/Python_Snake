...
class World(object):
    def __init__(self, size, custom, start_position, start_direction_index, food_position):
        ...
        self.world = np.transpose(self.world)
        self.world[0] = self.WALL
    ...
    def init_snake(self):
        ...
        if not self.custom:
            ...
            start_position = tuple([random.randint(SNAKE_SIZE, self.size[0] - SNAKE_SIZE - 1),
                                    random.randint(SNAKE_SIZE, self.size[1] - SNAKE_SIZE - 1)])
    ...
    def init_food(self):
        ...
        if not self.custom:
            ...
            chosen_position = tuple(random.choice(list(available_food_positions)))
        else:
    ...
    def move_snake(self, action):
        ...
        if self.snake.alive:
            ...
            elif new_snake_head in self.snake.blocks[1:] or new_snake_head == old_snake_tail:
                self.snake.alive = False
